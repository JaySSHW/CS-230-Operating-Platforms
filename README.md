...
### Client Summary
The client, The Gaming Room, wanted to expand their Android game Draw It or Lose It into a web-based, cross-platform application. The system needed to support multiple teams and players, enforce unique game and team names, and maintain a single instance of the game service while still generating unique IDs for games, teams, and players. The goal was to create a scalable design that could support many concurrent users and work across desktop and mobile browsers.
### What I Did Well
...
### My Design Approach
I approached the design using requirement analysis, UML-style domain modeling, and evaluation of operating platforms. In future projects, I would also include early prototyping and user-feedback testing to strengthen the design process.
